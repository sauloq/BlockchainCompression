...
# Michael Ting                                          #
# https://github.com/michaelting/BWT                    #
# 10 October 2013                                       #
#=======================================================#
"""
...
def DC3_radixsort(suftuplst, iternum):
    ...
    keysortedbuckets = sorted(buckets) # sort by numerical value
    # order the suffixes
    ordered = []
...
if __name__ == "__main__":
    encoded = encode_BWT("salamandra$")
    decoded = decode_BWT(encoded)
    print(encoded)
    print(decoded)
